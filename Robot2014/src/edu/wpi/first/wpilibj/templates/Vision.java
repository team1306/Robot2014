...
class Vision {
    ...
    private static final double VIEW_ANGLE = 49;		//Axis M1013
    ...
    class ImageData {
        ...
        ImageData(double distance, boolean hot) {
            this.distance = distance;
            this.hot = hot;
        }
        final private boolean hot;
...
//                image = new RGBImage("/testImage.jpg");		// get the sample image from the cRIO flash
            ...
            if (filteredImage.getNumberParticles() > 0) {
                ...
                if (verticalTargetCount > 0) {
                    ...
                    if (target.hot) {
                        data = new ImageData(distance, true);
                    } else {
                        data = new ImageData(distance, false);
                    }
                }
            }
